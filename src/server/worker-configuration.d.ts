/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: af1685ffbb519a7184ad1b57d6cfcc18)
// Runtime types generated with workerd@1.20250508.0 2025-04-01 
declare namespace Cloudflare {
	interface Env {
		Chat: DurableObjectNamespace<import("./index").Chat>;
		Tandem: DurableObjectNamespace<import("./index").Tandem>;
		ASSETS: Fetcher;
	}
}
